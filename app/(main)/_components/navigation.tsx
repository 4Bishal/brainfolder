...
const Navigation = () => {
    ...
    // --- Handle sidebar resizing (desktop)
    ...
    useEffect(() => {
        ...
        const handleTouchEnd = (e: TouchEvent) => {
            ...
            if (diff < -50) collapse(); // left swipe → collapse
            if (diff > 50) resetWidth(); // right swipe → open
        };
    ...
    // --- Ensure collapse on initial mobile load
    useEffect(() => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="mt-4 flex flex-col justify-evenly gap-2">
                    <DocumentList />
                    <Item label="Add a page" icon={Plus} onClick={handleCreate} />
                    <Item icon={Trash} label="Trash" onClick={trash.onOpen} />
                </div>
